...
def build_pipeline() -> Diagram:
    ...
    nodes = [
        ...
        Node("assistant", "Headless Curation Room\nagent proposes; human decides", 800, 445, 230, 100, "integration"),
...
def deployment_process() -> Diagram:
    ...
    nodes = [
        ...
        Node("http_runtime", "Headless runtime + curation\nmno-runtime / mno-curate", 885, 375, 270, 88, "runtime"),
